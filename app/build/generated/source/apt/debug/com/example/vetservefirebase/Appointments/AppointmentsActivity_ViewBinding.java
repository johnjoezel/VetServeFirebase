...
public class AppointmentsActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public AppointmentsActivity_ViewBinding(AppointmentsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AppointmentsActivity_ViewBinding(final AppointmentsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AppointmentsActivity target = this.target;
    ...
    view7f0a0028 = null;
    view7f0a0029.setOnClickListener(null);
    view7f0a0029 = null;
